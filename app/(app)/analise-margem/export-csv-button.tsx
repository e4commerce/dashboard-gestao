...
function buildRow(p: DailyMarginPoint): string {
  ...
  return [
    ...
    brNumber(p.cogsValidEstimated),
    p.cogsRateUsed !== null ? brNumber(p.cogsRateUsed * 100, 2) : "",
    brNumber(p.adSpend),
...
function buildTotalRow(t: MarginTotals): string {
  ...
  return [
    ...
    brNumber(t.cogsValidEstimated),
    t.cogsRateUsed !== null ? brNumber(t.cogsRateUsed * 100, 2) : "",
    brNumber(t.adSpend),
